...
MESSAGES: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "plan_month_name": "1 Месяц (28 дней)",
        "plan_month_desc": "Доступ к удалённым и одноразовым сообщениям на 28 дней (Выгодно)",
    ...
    "uz": {
        ...
        "plan_month_name": "1 Oy (28 kun)",
        "plan_month_desc": "O'chirilgan va 1 martalik xabarlarni 28 kun davomida tutib olish xizmati (Tejamkor)",
